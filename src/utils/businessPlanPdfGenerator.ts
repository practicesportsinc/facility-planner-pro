...
export async function generateBusinessPlanPdf(data: BusinessPlanData, aiContent?: any) {
  ...
  doc.text(data.projectOverview.facilityName || 'Sports Facility', pageWidth / 2, y, { align: 'center' });
  y += 15;
  ...
  for (let i = 1; i <= pageCount; i++) {
    ...
    doc.text(`Generated by SportsFacility.ai | Page ${i} of ${pageCount}`, pageWidth / 2, 285, { align: 'center' });
  }
