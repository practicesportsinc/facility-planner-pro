...
const breadcrumbConfig: BreadcrumbConfig = {
  ...
  "start": { label: "Start" },
  "wizard": { label: "Wizard" },
  "wizard/easy": { label: "Easy Wizard" },
  "wizard/easy/start": { label: "Sports Selection" },
  "wizard/easy/size": { label: "Facility Size" },
  "wizard/easy/products": { label: "Equipment" },
  "wizard/easy/context": { label: "Location & Timeline" },
  "wizard/easy/results": { label: "Results" },
